...
let PopupContainer = function (p) {
	...
	this.show = function(callbackFunc) {
		if(thatPopContainer.isHidden){
			...
			let boxZIndex = cmnPcr.getTopZIndex();
			//alert(popSize.width)
			let popHtml = "<div class=\"s3dPopOverlay\" id=\"" + thatPopContainer.overlayId + "\" style=\"z-index:" + overlayZIndex + ";\">"
				+ "<div class=\"s3dPopGround\"></div>"
				+ "<div class=\"s3dPopBox\" id=\"" + thatPopContainer.boxId + "\" style=\"z-index:" + boxZIndex + ";left:" + newPos.left + "px;top:" + thatPopContainer.top + "px;width:" + popSize.width + "px;height:" + popSize.height + "px;\">"
				+ "<div class=\"s3dPopTitle\"></div><div class=\"s3dPopCloseBtn\">×</div>"
				+ "<div class=\"s3dPopInnerBox\" id=\"" + thatPopContainer.contentId + "\"></div>"
				+ "</div>"
				+ "</div>";
...
//信息类型
export const paramType={string:"string", decimal:"decimal", integer:"integer", boolean:"boolean", date:"date", time:"time", color:"color", distance:"distance", angle:"angle"};
...
export const s3dUiStatus = {normalView: "normalView", selectPoints: "selectPoints", specialView: "specialView", disable: "disable", edit: "edit", add: "add", pop: "pop", draw: "draw", locateMaterial: "locateMaterial"};

export const s3dUiStatusText = {normalView: "常规", selectPoints: "选点", specialView: "特殊", disable: "禁用", edit: "修改", add: "新增", pop: "弹出窗口", draw: "绘制"};

//viewer执行的操作
export const s3dOperateType = {
	transform: "transform",
...
export const s3dAnimationEditType = {add: "add", delete: "delete",  edit: "edit", editName: "editName", addGroup: "addGroup", removeGroup: "removeGroup", addKeyFrame: "addKeyFrame", removeKeyFrame: "removeKeyFrame", editKeyFrameIndex: "editKeyFrameIndex", editKeyFrameValue: "editKeyFrameValue", editKeyFrameLineType: "editKeyFrameLineType"};

export const s3dContent2DEditType = {add: "add", delete: "delete",  edit: "edit", editName: "editName"};

export const s3dProgressEditType = {add: "add", delete: "delete",  edit: "edit", editName: "editName", addGroup: "addGroup", removeGroup: "removeGroup", addStep: "addStep", removeStep: "removeStep", editStep: "editStep"};

export const s3dMaterialEditType = {add: "add", delete: "delete",  edit: "edit", editProperty: "editProperty"};

export const s3dOperateTypeName = {transform: "移动旋转缩放", changeParent: "更改结构", edit: "编辑", add: "添加", delete: "删除", splitLocal: "分解", none: "无", animation: "编辑动画", progress: "编辑流程",  material: "编辑材质"};
...
export const s3dElement3DType = {group: "group", unit: "unit", camera: "camera", light: "light", particle: "particle", tag: "tag", orbit: "orbit"};

export const s3dAnimationGroupType = {property: "property", material: "material"}

export const s3dProgressGroupType = {property: "property", material: "material"}
export const s3dTransformMode = {rotation: "rotate", position: "position", scale: "scale"}

export const s3dLayerType = {viewLayer: 0, editLayer: 1, controlLayer: 2}

export const s3dClockDirection = {clockwise: "clockwise", anticlockwise: "anticlockwise"};

export const s3dContent2DShiftType = {fadeInOut: "fadeInOut", horizontal: "horizontal", vertical: "vertical"};

export const s3dContent2DShiftName = {fadeInOut: "淡入淡出", horizontal: "水平滑入", vertical: "竖直滑入"};

export const s3dImageSourceType = {object: "object", local: "local", system: "system"};

export const s3dTextDirections = [
	{
		code: "Horizontal",
		name:"横向"
	},
