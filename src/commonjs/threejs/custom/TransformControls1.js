...
const _attachChangeEvent = {type: "attachChange"};

class TransformControls1 extends Controls {
...
export { TransformControls1, TransformControlsGizmo, TransformControlsPlane };
