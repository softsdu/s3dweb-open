...
let S3dAppearanceSetting = function (){
	...
	this.getGroupHtml = function (groupJson, checked){
		return ("<div class=\"s3dAppearanceSettingGroupContainer" + (checked ? " s3dAppearanceSettingGroupContainerActive" : "") + "\" \" groupCode=\"" + groupJson.code + "\" title=\"" + cmnPcr.htmlEncode(groupJson.name) + "\">"
	...
	this.getBtnHtml = function(btnJson, groupCode, checked){
		if(btnJson.imgData == null){
			return "<div class=\"s3dAppearanceSettingBtnContainer s3dAppearanceSettingBtnContainerOnlyText\" itemCode=\"" + btnJson.code + "\" groupCode=\"" + groupCode + "\" title=\"" + cmnPcr.htmlEncode(btnJson.name) + "\">"
			...
			if(btnJson.imgData.normal != null) {
				...
				return "<div class=\"s3dAppearanceSettingBtnContainer\" itemCode=\"" + btnJson.code + "\" groupCode=\"" + groupCode + "\" title=\"" + cmnPcr.htmlEncode(btnJson.name) + "\">"
				...
				return "<div class=\"s3dAppearanceSettingBtnContainer\" itemCode=\"" + btnJson.code + "\" groupCode=\"" + groupCode + "\" title=\"" + cmnPcr.htmlEncode(btnJson.name) + "\">"
					...
					+ "<div class=\"s3dAppearanceSettingBtnName" + (checked ? " s3dAppearanceSettingBtnNameActive" : "") + "\">" + cmnPcr.htmlEncode(btnJson.name) + "</div>"
					+ "</div>";
			}
		}
	}
