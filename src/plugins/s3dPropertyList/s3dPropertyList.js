...
let S3dPropertyList = function (){
	...
	this.getPropertyHtml = function(paramName, paramValue){
		return "<div class=\"s3dPropertyListItemContainer\">"
			+ "<div class=\"s3dPropertyListItemTitle\">" + cmnPcr.htmlEncode(paramName) + "</div>"
			+ "<div class=\"s3dPropertyListItemValue\">" + cmnPcr.htmlEncode(paramValue) + "</div>"
			+ "</div>";
	}
	...
	this.getGroupHtml = function(groupName){
		return "<div class=\"s3dPropertyListItemContainer\">"
			+ "<div class=\"s3dPropertyListItemGroup\">" + cmnPcr.htmlEncode(groupName) + "</div>"
			+ "</div>";
	}
}
