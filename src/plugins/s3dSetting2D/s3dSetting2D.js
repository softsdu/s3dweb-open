...
let S3dSetting2D = function (){
	...
	this.getCurrentCameraInfo = function(){
		...
		$(container).find(".s3dSetting2DItemInput[name='cameraTarget']").val(
			common3DFunction.s2v(cameraInfo.target[0], thatS3dSetting2D.manager.viewer.distanceRatio).toFixed(0) + ", " +
			common3DFunction.s2v(cameraInfo.target[1], thatS3dSetting2D.manager.viewer.distanceRatio).toFixed(0) + ", " +
			common3DFunction.s2v(cameraInfo.target[2], thatS3dSetting2D.manager.viewer.distanceRatio).toFixed(0));
		$(container).find(".s3dSetting2DItemInput[name='cameraPosition']").val(
			common3DFunction.s2v(cameraInfo.position[0], thatS3dSetting2D.manager.viewer.distanceRatio).toFixed(0) + ", " +
			common3DFunction.s2v(cameraInfo.position[1], thatS3dSetting2D.manager.viewer.distanceRatio).toFixed(0) + ", " +
			common3DFunction.s2v(cameraInfo.position[2], thatS3dSetting2D.manager.viewer.distanceRatio).toFixed(0));
	...
	this.getValues = function(){		
		...
		if(targetStr.length !== 0){
			...
			cameraInfo = {
				type: "Orthographic",
				target: [
					common3DFunction.v2s(cmnPcr.strToDecimal(targetStrs[0]), thatS3dSetting2D.manager.viewer.distanceRatio),
					common3DFunction.v2s(cmnPcr.strToDecimal(targetStrs[1]), thatS3dSetting2D.manager.viewer.distanceRatio),
					common3DFunction.v2s(cmnPcr.strToDecimal(targetStrs[2]), thatS3dSetting2D.manager.viewer.distanceRatio)
				],
				position: [
					common3DFunction.v2s(cmnPcr.strToDecimal(positionStrs[0]), thatS3dSetting2D.manager.viewer.distanceRatio),
					common3DFunction.v2s(cmnPcr.strToDecimal(positionStrs[1]), thatS3dSetting2D.manager.viewer.distanceRatio),
					common3DFunction.v2s(cmnPcr.strToDecimal(positionStrs[2]), thatS3dSetting2D.manager.viewer.distanceRatio)
				],
	...
	this.refreshValues = function(){
		...
		$(container).find(".s3dSetting2DItemInput[name='cameraTarget']").val(common3DFunction.s2v(cameraInfo.target[0], thatS3dSetting2D.manager.viewer.distanceRatio)
			+ ", " + common3DFunction.s2v(cameraInfo.target[1], thatS3dSetting2D.manager.viewer.distanceRatio)
			+ ", " + common3DFunction.s2v(cameraInfo.target[2], thatS3dSetting2D.manager.viewer.distanceRatio));
		$(container).find(".s3dSetting2DItemInput[name='cameraPosition']").val(common3DFunction.s2v(cameraInfo.position[0], thatS3dSetting2D.manager.viewer.distanceRatio)
			+ ", " + common3DFunction.s2v(cameraInfo.position[1], thatS3dSetting2D.manager.viewer.distanceRatio)
			+ ", " + common3DFunction.s2v(cameraInfo.position[2], thatS3dSetting2D.manager.viewer.distanceRatio));
	...
	this.getWinHtml = function(){
		...
		return  "<div class=\"s3dSetting2DContainer\">"
			...
			+ "</div>"
			+ "<div class=\"s3dSetting2DItemGroupContainer\">"
			+ "<div class=\"s3dSetting2DItemGroupTitle\">网格</div>"
			+ "</div>"
			+ "<div class=\"s3dSetting2DItemContainer\">"
			...
			+ "</div>"
			+ "<div class=\"s3dSetting2DItemGroupContainer\">"
			+ "<div class=\"s3dSetting2DItemGroupTitle\">初始视角</div>"
