...
import {cmnPcr, s3dLayerType} from "../../commonjs/common/common.js"
...
let S3dAxis = function (){
	...
	this.initMaterials = function (){
		...
		thatS3dAxis.planeMaterial = new THREE.MeshStandardMaterial({
		...
		//刻度字体材质
		thatS3dAxis.textMaterial = new THREE.MeshStandardMaterial({
    ...
    this.addAxisLines = function(lineInfos, direction, textParameter){      	
    	...
    	for(let i = 0; i < lineInfos.length; i++){ 
			...
			let line = new THREE.LineSegments(geometry, lineInfo.material);
