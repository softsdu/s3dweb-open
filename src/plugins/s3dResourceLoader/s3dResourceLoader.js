...
import * as zip from "../../commonjs/zipjs/index.js";
...
import {cmnPcr, msgBox, s3dResourceType} from "../../commonjs/common/common.js"
...
let S3dResourceLoader = function (){
	...
	this.createErrorMesh = function (){
		...
		return new THREE.Mesh(geometry, thatS3dResourceLoader.errorMaterial);
	}
